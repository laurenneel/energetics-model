...
path_txt_input_folder='/Users/laurenneel/Desktop/Grass_RGB_DSM_Oct22/WC2/'
finput = open(path_txt_input_folder + "WC2_elev_1m", "r")
ELEV = []
ELEV = read_it()
...
finput = open(path_txt_input_folder + "WC2_slope_1m", "r")
SLOPE = []
SLOPE= read_it()
...
finput = open(path_txt_input_folder + "WC2_VARI_1m", "r")
VEG = []
VEG= read_it()
...
finput = open(path_txt_input_folder + "WC2_aspect_1m", "r")
ASPECT = []
ASPECT= read_it()
...
micro_df = pd.read_csv("/Users/laurenneel/Desktop/Grass_RGB_DSM_Oct22/microclim_input_era5/hourly_df_WC_2021.csv")
...
def do_sim():
	...
	class T_e():
		def __init__(self, emissivity = 0.95, phi = 34., longitude = 109., elev = 0., h = 0.07, d = 0.2, emmiss_animal = 0.95, sky = 0.7, r_soil = 0.3, emmiss_soil = 0.94, abs_animal_long = 0.97, abs_animal_short = 0.7, Ta_min0 = 20., Ta_min1 = 20., Ta_min2 = 20., Ta_max0 = 35., Ta_max1 = 35., Ta_max2 = 35., ampl = 15., wind = 0.1):
			...
			self.x_max, self.y_max = 140., 140. #x_max = ncols, y_max = nrows #### CHANGED FROM SEARS 99. for each 8feb!
...
#           #output.write(str(e_range) + "\t" + str(e_fract) + "\t" + str(v_range) + "\t" + str(v_fract) +"\t" + str(t)+ "\t" + str(lizard.position['x']) + "\t" +str(lizard.position['y']) + "\t" + str(lizard.te) + "\t" +str(lizard.tb) + "\t" + str(lizard.active) +"\t" + str(lizard.mei())+"\t" + str(lizard.smr()) + "\t" + str(lizard.net())  + "\t"+ str(lizard.moved)+ "\t"+ str(lizard.ate)+"\n")
	...
	with open('WC_overall_averages.csv', mode='w', newline='') as output_file: 
    ...
    # calculate overall averages
		...
		with open('WC_daily_averages.csv', mode='a', newline='') as output_file:
